    ...
    <div className="flex-col gap-2 px-4 py-2 w-full">
      ...
      {languages.map((lang) => (
        <button
          ...
          className={`flex items-center text-black hover:bg-gray-100 justify-between gap-2 w-full px-3 py-2 text-sm${locale === lang.code
            ? "bg-gray-100 font-semibold border-gray-400"
            : "bg-white border-gray-300"
            }`}
        >
          <span className="flex items-center gap-2 text-sm font-medium text-black mb-1">
